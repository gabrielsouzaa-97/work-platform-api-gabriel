...
| ISSUE-037 | security | `ApiKey.scopes` nunca aplicado + sem autorização por tenant — qualquer chave age sobre qualquer customer (IDOR latente; vira CRITICAL ao abrir `/v1` a terceiros) | Core (Auth/api-key), Customers | HIGH | Sprint **F15** planejada (`/rock` 2026-06-16) — SEC-V1-001 |
...
- **Status**: open — Sprint **F15** planejada via `/rock` (2026-06-16); executar `/pmo sprint F15`
